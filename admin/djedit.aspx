<%@ Page Language="C#" AutoEventWireup="true" CodeFile="djedit.aspx.cs" Inherits="admin_djedit" %>
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                                <table style="margin: 0 auto; line-height:78px;">
                                      <tr style="margin-bottom:10px;">
                                          ...
                                          <td><asp:TextBox CssClass="tex1" ID="TextBox1" disabled="disabled" runat="server"></asp:TextBox></td>
                                      </tr>
                                      <tr>
                                          <td style="font-size: 16px;color: #6d6a6a;padding: 0px 18px;">起始积分</td>
                                          <td><asp:TextBox CssClass="tex1" ID="TextBox2" disabled="disabled" runat="server"></asp:TextBox></td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                           <td ></td>
                                          <td ><asp:Button ID="Button1" CssClass="tj" runat="server" Text="修改" 
